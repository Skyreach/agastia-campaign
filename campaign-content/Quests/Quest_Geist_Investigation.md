---
name: Geist Investigation
type: Quest
status: Active
version: "2.0.0"
tags: [quest, kyle-quest, investigation, geist, kaelborn, starfall-anchors, chaos-cult, 3-3-3-1-mystery]
quest_giver: Kyle/Nameless (self-directed)
location: Agastia (Dock District, Merchant District, Scholar Quarter, The Depths)
difficulty: Medium
level_range: 2-4
related_entities: [Kyle/Nameless, Geist, Kaelborn, Harren Dockwise, Mira Saltwind, Kex the Fence, The Architect, Chaos Cult, Lord Zaos, The Augury]
---
...
```mermaid
graph TD
    Start([Discover Mystery])

    Entry1[Crate Scene<br/>Dead smuggler]
    Entry2[Mira's Shop<br/>Extorted merchant]
    Entry3[Kex the Fence<br/>Criminal intel]

    Start --> Entry1
    Start --> Entry2
    Start --> Entry3

    Entry1 -->|Warehouse label| W7[Warehouse 7]
    Entry1 -->|Business card| Mira[Mira's Shop]
    Entry1 -->|Note mention| Cult[Cult Safehouse]

    Entry2 -->|Manifest| Aug[The Augury]
    Entry2 -->|Dock intel| W7
    Entry2 -->|Pattern| MC[Merit Council]

    Entry3 -->|Operations| W7
    Entry3 -->|Buyer rumors| Cult
    Entry3 -->|Corruption| MC

    W7 -->|Research docs| Aug
    W7 -->|Paperwork| MC
    W7 -->|Letter| Cult
    ...
    style Entry1 fill:#ff6b6b
    style Entry2 fill:#ff6b6b
    style Entry3 fill:#ff6b6b
    style W7 fill:#4dabf7
    style Aug fill:#4dabf7
    style MC fill:#4dabf7
    style Cult fill:#9775fa
```
