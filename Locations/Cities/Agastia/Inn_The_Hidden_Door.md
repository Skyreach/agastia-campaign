...
type: Inn
subtype: Underground Inn & Safe House
district: The Depths
city: Agastia
tier: 7
status: Active
...
- Shrewd judge of character - knows when someone's truly in need vs. truly dangerous
- Warm to those she trusts, ice-cold to threats
...
**Hours:**
- Always open - Senna or her assistant is always present
- Quietest: Midday (most guests sleep then or are out working)
- Busiest: Evening/night (people coming to hide, to rest, to meet)

**Typical Day:**
- Morning: Senna prepares communal breakfast, checks on long-term guests
- Midday: Cleaning, food prep, quiet hours
- Afternoon: Interviews potential new guests (careful screening)
- Evening: Busiest time, new arrivals, meals served, information exchanged
...
**Pricing (Flexible Based on Need):**
- **Private room:** 5 sp/night (truly private, locked door, clean)
- **Shared room:** 2 sp/night (bunk in common area, safe but not private)
- **Crash space:** 5 cp/night or free (floor space, blanket, for those with nothing)
- **Meal:** 3 cp (mushroom stew, bread, water - always available)
- **Ale:** 2 cp (weak, but drinkable)

**Special Services:**
- **No-name registry:** No records kept of who stays (default, not extra charge)
- **Message drop:** Leave message for someone, Senna holds it securely (1 sp)
- **Storage:** Hide items, no questions (1 sp per week)
...
4. Don't bring trouble that follows (if guards show up, you leave immediately)
5. Respect Senna's judgment (her house, her rules)

**Inventory:**

**Toggle: Common Items (Always Available)**
- **Meals:** Mushroom stew (endless), bread (baked daily), water (clean)
- **Ale:** Weak house brew
- **Blankets:** Clean, if worn
- **Candles:** For private rooms
- **Basic amenities:** Wash basin, soap, towels
- **Medical supplies:** Bandages, salves, basic herbs

**Toggle: Uncommon Items (Sometimes Available - Underground Network)**
- **False papers:** 25 gp - Senna knows forger, can arrange (not perfect, but serviceable)
- **Disguise kit:** 10 gp - clothes, wig, makeup for blending in
...
**Personality Quirks:**
- Never forgets a face or a kindness
- Speaks softly but commands immediate respect
- Tests newcomers subtly before deciding if she trusts them
- Has code phrases guests use to identify each other ("looking for a hidden door" = seeking sanctuary)
...
- Sense of community despite desperation - people here help each other
- Wariness - guests don't make eye contact, don't ask questions
- Safety despite danger - this place is protected by absolute discretion
