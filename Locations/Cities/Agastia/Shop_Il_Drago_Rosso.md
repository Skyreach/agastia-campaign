...
### Papa Biago
**Role:** Co-proprietor, front-of-house manager, and the trattoria's gregarious heart
...
### Mama Biago
**Role:** Co-proprietor, head chef, and the trattoria's real power
...
- Uncannily perceptive - reads intentions, lies, hidden agendas effortlessly
- Fiercely protective - of family, staff, customers, and the sanctuary she's built
- Pragmatic and wise - understands power dynamics better than most politicians
- Warm but formidable - can switch from nurturing grandmother to immovable force instantly
...
**Hours:**
- Full day (11am-11pm): Lunch and dinner service
- Kitchen prep (7am-11am): Mama and staff preparing daily specials
- Late night (11pm-1am): Private room available for "sensitive" meetings (by reservation)
- Family time (1am-7am): Closed, family quarters above restaurant
...
**Real Uses:**
- **Neutral Ground:** Primary function - factions can meet without violence
- **Information Hub:** The Biagos see and hear everything but never weaponize it
- **Social Bridge:** Different merit levels mix here naturally
- **Sanctuary:** Safe haven for those who need brief refuge
- **Cultural Anchor:** Reminder that some things (good food, family) transcend faction politics
- **Intelligence Asset:** Knowledge flows through but isn't exploited (yet)
...
**Dining:**
- Exceptional Italian cuisine (Papa's recipes, Mama's execution)
- Daily specials based on fresh market ingredients
- Accommodates dietary restrictions and preferences
- Will modify dishes for regular customers' tastes
- Private dining room available (reservation required, discrete)

**Lodging:**
- Comfortable rooms above restaurant (5sp/night)
- Simple but clean, always include fresh bread and wine
- Quiet despite location (Mama doesn't tolerate noise)
- Emergency refuge for those in genuine need (Biagos' discretion)

**Special Services:**
- **Neutral Ground Meetings:** Private room rental (10gp, includes meal)
- **Message Delivery:** Papa will pass discreet messages between customers (5gp, absolute discretion)
- **Social Introduction:** The Biagos can arrange introductions across faction lines (priceless, earned through trust)
- **Truth Reading:** Mama will tell you if someone is lying (not a service you ask for - she volunteers)

### Menu & Pricing

**Toggle: Breakfast (7am-11am, Limited Availability)**
- Fresh bread and butter (1cp)
- Coffee with grappa (3cp)
- Eggs and sausage (5cp)
- Morning pastries (2cp each)

**Toggle: Lunch & Dinner (Full Menu)**

**Antipasti (Starters):**
- Bruschetta al Pomodoro (2sp) - Grilled bread, tomato, basil, garlic
- Arancini (3sp) - Fried risotto balls with cheese
- Caprese Salad (4sp) - Tomato, mozzarella, basil, balsamic
...
- Gnocchi al Pesto (5sp) - Potato dumplings, basil pesto

**Secondi (Main Course - Meat/Fish):**
- Pollo alla Parmigiana (8sp) - Breaded chicken, tomato sauce, cheese
- Saltimbocca alla Romana (10sp) - Veal, prosciutto, sage, white wine
- Osso Buco (12sp) - Braised veal shank, gremolata (Papa's specialty)
- Pesce al Forno (9sp) - Baked fish, lemon, herbs (when available)
- Bistecca alla Fiorentina (15sp) - Grilled T-bone steak (for special occasions)

**Contorni (Sides):**
- Roasted vegetables (2sp)
- Polenta (2sp)
- Sautéed greens (2sp)
- House salad (1sp)

**Dolci (Desserts):**
- Tiramisu (4sp) - Mama's signature dessert
- Panna Cotta (3sp) - Vanilla cream with berry sauce
- Cannoli (3sp each)
- Biscotti with dessert wine (2sp)

**Beverages:**
- House wine (1sp/glass, 8sp/bottle)
- Premium wine (5sp/glass, 40sp/bottle)
- Grappa (3sp)
- Coffee (2cp)
- Limoncello (2sp) - homemade

**Toggle: Special Occasion Meals (Advance Notice Required)**
- **Family Feast** (50gp, serves 8-10): Multi-course meal, finest ingredients, Mama cooks personally
- **Wedding Banquet** (negotiable): Full catering, private dining room, the works
- **Faction Negotiation Dinner** (100gp): Private room, extended hours, Biagos ensure absolute privacy

**Pricing Philosophy:** Fair prices for quality that transcends tier. A Tier 2 noble pays the same as a Tier 5 worker - this is sacred principle. Biagos want everyone to afford their food.
...
- **Various Faction Representatives:** All use Delizioso for unofficial meetings
- **The Exchange Merchants:** Daily interaction during ingredient shopping
...
**The Neutral Ground Under Threat:**
- New faction leader doesn't respect tradition, tries to use Delizioso for ambush
- Biagos need party to demonstrate that violating sanctuary has consequences
- Reward: Permanent free meals for party, private room access, Biagos' genuine trust
...
- Difficulty: Moderate (investigation, possible confrontation)

**Papa's Dilemma:**
- Overheard conversation reveals plot against someone Papa likes
- His neutrality prevents warning them, but he can't let them die
- Uses party as proxy to intervene
- Reward: Major faction favor (whoever was saved), Papa's undying gratitude
- Difficulty: Variable (time-sensitive, may involve faction politics)
...
- Difficulty: None (social encounter, potential for deep character moments)

### Personality Quirks

**Papa Biago:**
- Remembers every dish every customer has ever ordered
- Tells same stories repeatedly but somehow makes them fresh each time
...
- Knows when someone's lying before they finish the sentence
...
- Papa keeps mental log of every significant conversation overheard
- Doesn't write it down (too dangerous)
- Knows more about faction operations than most spymasters
- Has never used this knowledge for anything except keeping the peace
- This restraint is the only thing keeping the family safe

**Mama's Gift:**
- Her people-reading ability is genuinely supernatural (low-level divination)
- She doesn't know this - thinks everyone can tell when people lie
- This is why the neutral ground works - she prevents betrayals before they happen
- If tested, would register as minor magical aura (Detect Magic)
- Origin unknown, possibly inherited, never trained

**The Dead Man's Switch:**
- If Biagos are harmed, sealed letters go to multiple faction leaders
...
- If party reveals cult presence, Biagos face moral crisis:
  - Maintain neutrality and allow cult to continue using restaurant?
...
- But also the family's protection (reputation as neutral ground keeps them safe)
...
- Biagos preparing for this transition (hence worry about current tensions)
...
- But also makes them vulnerable if someone wants to eliminate neutral ground
...
- They will share carefully if it prevents greater harm
- Party's access to this intelligence is privilege, not transaction
- Misusing information breaks trust permanently
- But earning Biagos' trust opens doors across all faction lines
