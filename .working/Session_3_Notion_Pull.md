...
**Toggle: Session Flow**
  ...
  1.  Kyle/Nameless**'s Hook:** An encounter on the road that points Kyle/Nameless towards the docks and Geist.
  1.  **Player Choice Encounter:** An encounter that can be resolved in multiple ways.
  1.  **Arrival in Agastia:** First impressions of the city.
  1.  **Job Board:** Introduction to the system for gaining money and merit.
  1.  **The Steel Dragon:** The first murder scene is discovered.
  1.  **Player Quest Hooks:** Opportunities for Manny and Nikki to get involved in their quests.
**Toggle: Key NPCs**
...
1. **Feywild packing materials** (REVELATION) → Expensive Feywild artifacts being smuggled
1. **Smuggler's note** (LEAD + REVELATION) → Buyer "The Architect" wants 6 total, Saltwind Imports connection
1. **Business card** (LEAD) → Mira Saltwind in Merchant District
1. **Shadow burns** (REVELATION) → Dangerous magical cargo OR targeted killing
**DM Notes:**
...
1. **The Old Hollow:** A corrupted grove 1 hour west of the road
